...
// Set i2c address
PCF857X pcf857X(&I2Ctwo, 0x20);
// PCF857X pcf857X(&I2Ctwo, 0x20, 21, 22);
// PCF857X(TwoWire *pWire, uint8_t address, uint8_t interruptPin,  void (*interruptFunction)() );
// PCF857X(TwoWire *pWire, uint8_t address, uint8_t sda, uint8_t scl, uint8_t interruptPin,  void (*interruptFunction)());
