...
FT6336U::FT6336U(int8_t sda, int8_t scl) 
: sda(sda), scl(scl)  {
}
#endif
FT6336U::~FT6336U() {
...
void FT6336U::writeByte(uint8_t addr, uint8_t data) {
    DEBUG_FT6336U_PRINTLN("")
    DEBUG_FT6336U_PRINT("writeI2C reg 0x")
    DEBUG_FT6336U_PRINT(addr, HEX)
    DEBUG_FT6336U_PRINT(" -> 0x") 
    DEBUG_FT6336U_PRINTLN(data, HEX)
