...
#define DEBUG_FT6336U_PRINTER Serial

// Setup debug printing macros
#ifdef FT6336U_DEBUG
#define DEBUG_FT6336U_PRINT(...)                  \
    {                                     \
        DEBUG_FT6336U_PRINTER.print(__VA_ARGS__); \
    }
#define DEBUG_FT6336U_PRINTLN(...)                  \
    {                                       \
        DEBUG_FT6336U_PRINTER.println(__VA_ARGS__); \
    }
#else
#define DEBUG_FT6336U_PRINT(...) \
    {                    \
